...
setup(
    ...
    description="Simple image set structure for Tendril",
    long_description='\n'.join([read('README.rst'), read('CHANGELOG.rst')]),
    long_description_content_type='text/x-rst',
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-structures-imageset',
    project_urls={
        'Documentation': 'https://tendril-structures-imageset.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-structures-imageset/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-structures-imageset',
    },
