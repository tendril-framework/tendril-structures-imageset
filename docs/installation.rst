...
``tendril-structures-imageset`` can be installed normally from the Python Package Index.
...
.. code-block:: console
    ...
    $ pip install tendril-structures-imageset
...
`github releases <https://github.com/tendril-framework/tendril-structures-imageset/releases>`_.
...
``tendril-structures-imageset``. ``sudo`` may be necessary if you are not installing
into a virtual environment.

.. code-block:: console

    $ git clone https://github.com/tendril-framework/tendril-structures-imageset.git
    $ cd tendril-structures-imageset
    $ pip install -e .
